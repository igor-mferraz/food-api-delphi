...
type
  ...
  function InserirPedido(id_usuario: integer; endereco, fone: string;
      vl_subtotal, vl_entrega, vl_total: double; itens: TJSONArray): TJsonObject;
...
begin
        try
               ...
               qry.SQL.Add('insert into pedido(id_usuario, endereco, fone, vl_subtotal, vl_entrega, vl_total, dt_pedido, status)');
               qry.SQL.Add('values(:id_usuario, :endereco, :fone, :vl_subtotal, :vl_entrega, :vl_total, :dt_pedido, :status);');
               ...
               qry.ParamByName('dt_pedido').Value := FormatDateTime('yyyy-mm-dd hh:MM:ss', now);
